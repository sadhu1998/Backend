...
public class UserQueries {
    ...
    public String addUserToDbSql(AddUserRequest addUserRequest) {
        return "insert into users.details(id, username , phonenumber , bloodgroup , town , district , city , state , country , mailid , verification_status, pincode) values" + "('nextval('user_id')','" + addUserRequest.getUsername() + "','" + addUserRequest.getPhonenumber() + "','" + addUserRequest.getBloodgroup() + "','" + addUserRequest.getTown() + "','" + addUserRequest.getDistrict() + "','" + addUserRequest.getCity() + "','" + addUserRequest.getState() + "','" + addUserRequest.getState() + "','" + addUserRequest.getMailid() + "','FALSE', " + addUserRequest.getPincode() + ");" + "" +
